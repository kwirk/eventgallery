...
class EventgalleryHelpersImageLocal extends EventgalleryHelpersImageDefault
{
    ...
    public function getThumbUrl($width = 104, $height = 104, $larger = true, $crop = false)
    {
        ...
        return JURI::base() . "components/com_eventgallery/helpers/image.php?option=com_eventgallery&mode=" . $mode
        . "&width=" . $width . "&view=resizeimage&folder=" . $this->folder . "&file=" . urlencode($this->file);
    }
    ...
    public function getThumbImgTag($width = 104, $height = 104, $cssClass = "", $crop = false)
    {
        ...
        . $this->getThumbUrl($width, $height, true, $height == $width) . '\', sizingMethod=\'scale\');
    ...
    public function getImageUrl($width = 104, $height = 104, $fullsize, $larger = false)
    {
        if ($fullsize) {
            return JURI::base()
            . "components/com_eventgallery/helpers/image.php?option=com_eventgallery&mode=full&view=resizeimage&folder="
            . $this->folder . "&file=" . urlencode($this->file);
        } else {
            ...
            return
                JURI::base() . "components/com_eventgallery/helpers/image.php?option=com_eventgallery&width=" . $width
                . "&view=resizeimage&folder=" . $this->folder . "&file=" . urlencode($this->file);
        }
    }
