...
?>
<?php IF ($this->params->get('use_social_sharing_button', 0)==1 && $this->model->folder->attribs['use_social_sharing']==1):?>			    		
<a href="#" style="float: left" class="social-share-button" rel="sharingbutton-close"><i class="big"></i></a>	 

	<?php IF ($this->params->get('use_social_sharing_facebook', 0)==1 && $this->model->folder->attribs['use_social_sharing_facebook']==1):?>			    
	...
	<?php IF ($this->params->get('use_social_sharing_google', 0)==1 && $this->model->folder->attribs['use_social_sharing_google']==1):?>			    
	...
	<?php IF ($this->params->get('use_social_sharing_twitter', 0)==1 && $this->model->folder->attribs['use_social_sharing_twitter']==1):?>			    
	...
	<?php IF ($this->params->get('use_social_sharing_pinterest', 0)==1 && $this->model->folder->attribs['use_social_sharing_pinterest']==1):?>			    
	...
	<?php IF ($this->params->get('use_social_sharing_email', 0)==1 && $this->model->folder->attribs['use_social_sharing_email']==1):?>			    
	...
	<?php IF ($this->params->get('use_social_sharing_download', 0)==1 && $this->model->folder->attribs['use_social_sharing_download']==1):?>			    
