	...
	<form action="<?php echo JRoute::_("index.php?option=com_eventgallery&view=checkout&task=saveChanges") ?>" method="post" class="form-validate form-horizontal checkout-form">
		...
		<fieldset>
			<div class="form-actions">
				<input name="saveChanges" type="submit" class="validate btn" value="<?php echo JText::_('COM_EVENTGALLERY_CART_CHECKOUT_CHANGE_FORM_SAVE')?>"/>           
				<input name="continue" type="submit" class="validate btn btn-primary" value="<?php echo JText::_('COM_EVENTGALLERY_CART_CHECKOUT_CHANGE_FORM_CONTINUE')?>"/>           
			</div>
	    </fieldset>
