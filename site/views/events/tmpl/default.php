				...
				<?php IF ($count < $this->params->get('max_big_events',9999)): ?>
					<div class="item-container item-container-big">
						<div class="item item_first">
							<div class="content">				
								<div class="data">
									<?php IF($this->params->get('show_date',1)==1):?><div class="date"><a href="<?php echo JRoute::_("index.php?view=event&folder=".$this->entry->folder) ?>"><?php echo JHTML::Date($this->entry->date);?></a></div><?php ENDIF ?>
									<div class="title"><a  href="<?php echo JRoute::_("index.php?view=event&folder=".$this->entry->folder) ?>"><?php echo $this->entry->description;?></a></div>
									<?php IF($this->params->get('show_text',1)==1):?><div class="text"><a  href="<?php echo JRoute::_("index.php?view=event&folder=".$this->entry->folder) ?>"><?php echo $this->entry->text;?></a></div><?php ENDIF ?>
									<?php IF($this->params->get('show_imagecount',1)==1):?><div class="imagecount"><a href="<?php echo JRoute::_("index.php?view=event&folder=".$this->entry->folder) ?>"><?php echo JText::_('COM_EVENTGALLERY_EVENTS_LABEL_IMAGECOUNT') ?> <?php echo $this->entry->overallCount;?></a></div><?php ENDIF ?>				
