...
INSERT INTO `ztx1s_eventgallery_surcharge` (`id`, `ordering`, `classname`, `name`, `displayname`, `description`, `taxrate`, `price`, `currency`, `active`, `rule`, `modified`, `created`, `data`) VALUES
