    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th>
                    <?php echo JText::_( 'COM_EVENTGALLERY_IMAGESET_NAME' ); ?>
                </th>

                <th>
                    <?php echo JText::_( 'COM_EVENTGALLERY_IMAGESET_PRICING' ); ?>                     
                </th>               
            </tr>           
        </thead>
        ...
        ?>
            ...
            <tr class="row<?php echo $i % 2; ?>">
                ...
                <td> 
                     ...
                     <?php echo JText::_('COM_EVENTGALLERY_IMAGETYPE_TAXRATE') ?>:<?php echo $this->escape($item->getTaxRate()) ?>
                </td>
            </tr>
        <?php endforeach; ?>
        </tbody>
