    ...
    <table class="table">
        ...
        ?>
            ...
            <tr class="row<?php echo $i % 2; ?>">
                ...
                <td>
                	<div class="btn-group">
                        <?php echo JHtml::_('jgrid.published', $item->isPublished(), $i, 'paymentmethods.'); ?>
                        <?php IF ($item->isDefault()): ?>
                            <a href="#" class="btn btn-micro active"><i class="icon-star"></i></a>
                        <?php ELSE:?>
                            <a href="#" onclick="return listItemTask('cb<?php echo $i; ?>','paymentmethods.default')" class="btn btn-micro"><i class="icon-star-empty"></i></a>
                        <?php ENDIF ?>
