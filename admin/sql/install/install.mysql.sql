...
INSERT INTO `#__eventgallery_imagetype` (`id`, `type`, `isdigital`, `size`, `taxrate`, `price`, `currency`, `name`, `displayname`, `description`, `note`, `modified`, `created`) VALUES
...
INSERT INTO `#__eventgallery_orderstatus` (`id`, `type`, `name`, `default`, `displayname`, `description`, `modified`, `created`) VALUES
